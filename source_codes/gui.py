...
class internal_realization():
    ...
    def creating_saved_widgets(self, group_direct, content):
...
def run_gui(x,y):
    ...
    main_window = GUI.windows_constructor('', [543,317,x,y], [False,False], "wheat4")
